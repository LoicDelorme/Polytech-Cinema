...
<tags:default-page>
    <jsp:attribute name="title">Polytech Lyon - Filter actors</jsp:attribute>
    
    <jsp:attribute name="page_title">Filter actors</jsp:attribute>
    
    <jsp:attribute name="header_content"></jsp:attribute>
    
    <jsp:attribute name="body_content">
    		<form name="actorForm" method="post" action="/cinema/ActorController/filter">
