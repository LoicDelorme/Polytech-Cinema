...
<tags:default-page>
    <jsp:attribute name="title">Polytech Lyon - Add an actor</jsp:attribute>
    
    <jsp:attribute name="page_title">Add an actor</jsp:attribute>
    ...
    <jsp:attribute name="body_content">
	    ...
	    <script src="${js_actor_form}"></script>
    		...
    		<form name="actorForm" method="post" action="/cinema/ActorController/insert" onsubmit="return checkInputs()">
		    ...
		    <div class="form-group">
				...
				<input type="text" class="form-control" id="birthDate" name="birthDate" placeholder="Enter your birth date (dd-MM-yyyy)">
		    </div>
		    <div class="form-group">
				<label for="dateOfDeath">Date of death</label>
				<input type="text" class="form-control" id="dateOfDeath" name="dateOfDeath" placeholder="Enter your date of death (dd-MM-yyyy)">
		    </div>
